...
def calculate_volume_change_rate_and_analyze(data, digit_type="first"):
    ...
    if digit_type == "first":
        ...
        raise ValueError("Invalid digit type. Choose 'first' or 'second'.")
...
def plot_benford_graph(actual_frequencies, benford_dist, symbol, start_date, end_date, directories, digit_type, exchange):
    ...
    plt.title(f'{exchange.capitalize()} - {clean_symbol_name} Trade Volume Change Rate - Benford\'s Law Analysis ({digit_type} Digit) ({start_date} to {end_date})')
...
def plot_benford_table(actual_frequencies, benford_dist, symbol, start_date, end_date, directories, digit_type, exchange):
    ...
    plt.title(f'{exchange.capitalize()} - {clean_symbol_name} Trade Volume Change Rate - Benford\'s Law Table ({digit_type} Digit) ({start_date} to {end_date})')
    ...
    for symbol in symbols:
        ...
        if file_path:
            ...
            try:
                ...
                actual_frequencies, benford_dist = calculate_volume_change_rate_and_analyze(df, digit_choice)

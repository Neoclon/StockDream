...
def main():
    ...
    if file_path:
        ...
        perform_test = input("Do you want to perform the Chi-Square test? (Yes or No): ").strip().lower()
        if perform_test == "yes":
            perform_chi_square_test(actual_frequencies, benford_dist, symbol, start_date, end_date, save_directory)
    else:
